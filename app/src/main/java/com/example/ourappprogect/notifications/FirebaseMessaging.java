package com.example.ourappprogect.notifications;
...
import com.example.ourappprogect.ChatActivity;
import com.example.ourappprogect.PostDetailActivity;
...
public class FirebaseMessaging extends FirebaseMessagingService {
    ...
    private static final  String ADMIN_CHANEL_ID="admin_channel";
    @Override
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        super.onMessageReceived(remoteMessage);
        SharedPreferences sp = getSharedPreferences("SP_UUER",MODE_PRIVATE);
        String savedCurrerntUser = sp.getString("Current_USERID","None");
        ...
        if(notificationType.equals("PostNotification")){
            ...
            //don't show self notif
            if(!sender.equals(savedCurrerntUser)){
            ...
            if(fUser != null && sent.equals(fUser.getUid())){
                if (!savedCurrerntUser.equals(user)) {
    ...
    private void showPostNotification(String pId, String pTutle, String pDesc) {
        ...
        Bitmap laegeIcon = BitmapFactory.decodeResource(getResources(), R.drawable.donut);
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this,""+ADMIN_CHANEL_ID)
                ...
                .setLargeIcon(laegeIcon)
                .setContentText(pDesc)
                .setContentTitle(pTutle)
    ...
    private void setupPostNotificationChannel(NotificationManager notificationManager) {
        ...
        NotificationChannel adminChannel = new NotificationChannel(ADMIN_CHANEL_ID,channelName,NotificationManager.IMPORTANCE_HIGH);
